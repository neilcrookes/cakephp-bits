...
class GroupedItem extends CakeTestModel {
  ...
  var $actsAs = array('Sequence' => array('group_fields' => array('group_field')));
}
...
class SequenceBehaviorTestCase extends CakeTestCase {
    ...
    $expected = array(
      $GroupedItem->actsAs['Sequence']['group_fields'][0] => $GroupedItem->escapeField($GroupedItem->actsAs['Sequence']['group_fields'][0])
    );
